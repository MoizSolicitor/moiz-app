...
const Login = () => {
    ...
    const responseGoogle = (response) => {
     ...
     const  clientId='1052571088461-mikgh1dprv0l7fossifcrsshtcie7i80.apps.googleusercontent.com'
    useEffect(()=>{
  ...
  return (
    <div className='flex justify-start items-center flex-col h-screen'>
       <div className='relative w-full h-full'>
        ...
        <div className='absolute flex flex-col justify-center items-center top-0 right-0 left-0 bottom-0 bg-blackOverlayf'>
         <div className='p-5'>
